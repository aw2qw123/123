...
class LegalizeLog(Base):
    ...
    id = Column('legalize_id', String(128), primary_key=True, doc='认证申请ID')
    user_id = Column(String(128), ForeignKey('user_basic.user_id'), doc='用户ID')
    user = relationship('User', uselist=False)
    type = Column(Integer, doc='认证类型')
    status = Column(Integer, doc='申请状态')
    reject_reason = Column(String(50), doc='驳回原因')
    qualification_id = Column(String(128), ForeignKey('user_qualification.qualification_id'), doc='资质认证材料ID')
...
class Qualification(Base):
    ...
    id = Column('qualification_id', String(128), primary_key=True, doc='资质认证材料ID')
...
class User(Base):
    ...
    id = Column('user_id', String(128), primary_key=True, doc='用户ID')
...
class Relation(Base):
    ...
    id = Column('relation_id', String(128), primary_key=True, doc='主键ID')
    user_id = Column(String(128), ForeignKey('user_basic.user_id'), ForeignKey('user_profile.user_id'), doc='用户ID')
    target_user_id = Column(String(128), ForeignKey('user_basic.user_id'), doc='目标用户ID')
...
class Search(Base):
    ...
    ******************已废弃****************
    ...
    id = Column('search_id', String(128), primary_key=True, doc='主键ID')
    user_id = Column(Integer, doc='用户ID')
...
class Material(Base):
    ...
    id = Column('material_id', String(128), primary_key=True, doc='素材ID')
    user_id = Column(Integer, doc='用户ID')
